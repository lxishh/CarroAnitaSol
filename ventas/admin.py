...
class VentaAdmin(admin.ModelAdmin):
    list_display = ('id', 'vendedor', 'fecha', 'total')  # Campos que se mostrarán en la lista
    search_fields = ('vendedor__user__username', 'fecha')  # Permite buscar por el nombre de usuario de la vendedora o la fecha
